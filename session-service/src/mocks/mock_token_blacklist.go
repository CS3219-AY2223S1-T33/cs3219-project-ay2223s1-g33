...
// Source: cs3219-project-ay2223s1-g33/session-service/blacklist (interfaces: TokenBlacklist)
...
func (m *MockTokenBlacklist) AddToken(arg0 *blacklist.BlacklistToken) error {
	m.ctrl.T.Helper()
...
func (m *MockTokenBlacklist) IsTokenBlacklisted(arg0 *blacklist.BlacklistToken) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockTokenBlacklist) RemoveToken(arg0 *blacklist.BlacklistToken) error {
	m.ctrl.T.Helper()
