...
function Session() {
	...
	useEffect(() => {
		if (!yDoc) {
			...
			const tempprovider = new WebsocketProvider("ws://localhost:5001/", "ws", tempyDoc);
		...
		<>
			...
			<Grid templateColumns="1fr 2fr" mx="auto">
				...
				<Grid templateRows="7% 7fr auto" h="91vh">
					...
					{collabDefined && (
						<Editor yText={yText} provider={provider} undoManager={undoManager} nickname={nickname} />
					)}
					{/* Test case window */}
			...
			<Modal isOpen={isOpen} onClose={onClose} size="xl" isCentered>
				...
				<ModalContent>
					...
					<ModalBody>Leaving this session will also terminate this session with your buddy.</ModalBody>
					<ModalFooter>
						<HStack gap={4}>
