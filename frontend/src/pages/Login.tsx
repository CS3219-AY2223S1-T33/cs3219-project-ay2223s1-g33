...
import { LoginRequest, LoginResponse, UserCredentials } from "../proto/user-bff-service";
...
function Login() {
	...
	const validFormHandler = (data: any) => {
		...
		const loginReq = LoginRequest.fromJson({ credentials: UserCredentials.toJson(credentials) });
		axios
