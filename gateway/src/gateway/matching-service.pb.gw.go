...
func RegisterQueueServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QueueServiceServer) error {
	...
	mux.Handle("POST", pattern_QueueService_JoinQueue_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/matching_service.QueueService/JoinQueue", runtime.WithHTTPPathPattern("/matching_service.QueueService/JoinQueue"))
		if err != nil {
	...
	mux.Handle("POST", pattern_QueueService_CheckQueueStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/matching_service.QueueService/CheckQueueStatus", runtime.WithHTTPPathPattern("/matching_service.QueueService/CheckQueueStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterQueueServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QueueServiceClient) error {
	...
	mux.Handle("POST", pattern_QueueService_JoinQueue_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/matching_service.QueueService/JoinQueue", runtime.WithHTTPPathPattern("/matching_service.QueueService/JoinQueue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_QueueService_CheckQueueStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/matching_service.QueueService/CheckQueueStatus", runtime.WithHTTPPathPattern("/matching_service.QueueService/CheckQueueStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_QueueService_JoinQueue_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"matching_service.QueueService", "JoinQueue"}, ""))

	pattern_QueueService_CheckQueueStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"matching_service.QueueService", "CheckQueueStatus"}, ""))
)
