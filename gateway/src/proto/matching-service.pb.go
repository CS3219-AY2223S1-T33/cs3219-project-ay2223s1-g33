...
type LeaveQueueErrorCode int32

const (
	LeaveQueueErrorCode_LEAVE_QUEUE_ERROR_NONE     LeaveQueueErrorCode = 0
	LeaveQueueErrorCode_LEAVE_QUEUE_NOT_IN_QUEUE   LeaveQueueErrorCode = 1
	LeaveQueueErrorCode_LEAVE_QUEUE_BAD_REQUEST    LeaveQueueErrorCode = 100
	LeaveQueueErrorCode_LEAVE_QUEUE_INTERNAL_ERROR LeaveQueueErrorCode = 101
)

// Enum value maps for LeaveQueueErrorCode.
var (
	LeaveQueueErrorCode_name = map[int32]string{
		0:   "LEAVE_QUEUE_ERROR_NONE",
		1:   "LEAVE_QUEUE_NOT_IN_QUEUE",
		100: "LEAVE_QUEUE_BAD_REQUEST",
		101: "LEAVE_QUEUE_INTERNAL_ERROR",
	}
	LeaveQueueErrorCode_value = map[string]int32{
...
func (x LeaveQueueErrorCode) Enum() *LeaveQueueErrorCode {
	p := new(LeaveQueueErrorCode)
	*p = x
	return p
}

func (x LeaveQueueErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LeaveQueueErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_matching_service_proto_enumTypes[1].Descriptor()
}

func (LeaveQueueErrorCode) Type() protoreflect.EnumType {
	return &file_matching_service_proto_enumTypes[1]
}

func (x LeaveQueueErrorCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LeaveQueueErrorCode.Descriptor instead.
func (LeaveQueueErrorCode) EnumDescriptor() ([]byte, []int) {
...
func (QueueStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_matching_service_proto_enumTypes[3].Descriptor()
}

func (QueueStatus) Type() protoreflect.EnumType {
	return &file_matching_service_proto_enumTypes[3]
}
...
type JoinQueueRequest struct {
	...
	Difficulties []QuestionDifficulty `protobuf:"varint,1,rep,packed,name=difficulties,proto3,enum=common.QuestionDifficulty" json:"difficulties,omitempty"`
}
...
func (x *JoinQueueRequest) GetDifficulties() []QuestionDifficulty {
	if x != nil {
...
func (x *LeaveQueueRequest) Reset() {
	*x = LeaveQueueRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_matching_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LeaveQueueRequest) Descriptor() ([]byte, []int) {
	return file_matching_service_proto_rawDescGZIP(), []int{4}
}
...
type LeaveQueueResponse struct {
	...
	ErrorMessage string              `protobuf:"bytes,1,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	ErrorCode    LeaveQueueErrorCode `protobuf:"varint,2,opt,name=error_code,json=errorCode,proto3,enum=matching_service.LeaveQueueErrorCode" json:"error_code,omitempty"`
}

func (x *LeaveQueueResponse) Reset() {
	*x = LeaveQueueResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_matching_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LeaveQueueResponse) Descriptor() ([]byte, []int) {
	return file_matching_service_proto_rawDescGZIP(), []int{5}
}

func (x *LeaveQueueResponse) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
func (x *LeaveQueueResponse) GetErrorCode() LeaveQueueErrorCode {
	if x != nil {
		return x.ErrorCode
	}
	return LeaveQueueErrorCode_LEAVE_QUEUE_ERROR_NONE
}
...
var file_matching_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x52, 0x0a, 0x10, 0x4a, 0x6f, 0x69, 0x6e, 0x51,
	0x75, 0x65, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x0c, 0x64,
	0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0e, 0x32, 0x1a, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x51, 0x75, 0x65, 0x73, 0x74,
	0x69, 0x6f, 0x6e, 0x44, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x52, 0x0c, 0x64,
	0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x69, 0x65, 0x73, 0x22, 0x7d, 0x0a, 0x11, 0x4a,
	0x6f, 0x69, 0x6e, 0x51, 0x75, 0x65, 0x75, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x4c, 0x49, 0x44, 0x10, 0x03, 0x32, 0xa8, 0x02, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x53,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a, 0x0a, 0x4c, 0x65, 0x61, 0x76, 0x65,
	0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x23, 0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x51, 0x75,
	0x65, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x6d, 0x61, 0x74,
	0x63, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x65,
	0x61, 0x76, 0x65, 0x51, 0x75, 0x65, 0x75, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_matching_service_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_matching_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_matching_service_proto_goTypes = []interface{}{
	(JoinQueueErrorCode)(0),          // 0: matching_service.JoinQueueErrorCode
	(LeaveQueueErrorCode)(0),         // 1: matching_service.LeaveQueueErrorCode
	(CheckQueueStatusErrorCode)(0),   // 2: matching_service.CheckQueueStatusErrorCode
	(QueueStatus)(0),                 // 3: matching_service.QueueStatus
	(*JoinQueueRequest)(nil),         // 4: matching_service.JoinQueueRequest
	(*JoinQueueResponse)(nil),        // 5: matching_service.JoinQueueResponse
	(*CheckQueueStatusRequest)(nil),  // 6: matching_service.CheckQueueStatusRequest
	(*CheckQueueStatusResponse)(nil), // 7: matching_service.CheckQueueStatusResponse
	(*LeaveQueueRequest)(nil),        // 8: matching_service.LeaveQueueRequest
	(*LeaveQueueResponse)(nil),       // 9: matching_service.LeaveQueueResponse
	(QuestionDifficulty)(0),          // 10: common.QuestionDifficulty
}
var file_matching_service_proto_depIdxs = []int32{
	10, // 0: matching_service.JoinQueueRequest.difficulties:type_name -> common.QuestionDifficulty
	0,  // 1: matching_service.JoinQueueResponse.error_code:type_name -> matching_service.JoinQueueErrorCode
	3,  // 2: matching_service.CheckQueueStatusResponse.queue_status:type_name -> matching_service.QueueStatus
	2,  // 3: matching_service.CheckQueueStatusResponse.error_code:type_name -> matching_service.CheckQueueStatusErrorCode
	1,  // 4: matching_service.LeaveQueueResponse.error_code:type_name -> matching_service.LeaveQueueErrorCode
	4,  // 5: matching_service.QueueService.JoinQueue:input_type -> matching_service.JoinQueueRequest
	6,  // 6: matching_service.QueueService.CheckQueueStatus:input_type -> matching_service.CheckQueueStatusRequest
	8,  // 7: matching_service.QueueService.LeaveQueue:input_type -> matching_service.LeaveQueueRequest
	5,  // 8: matching_service.QueueService.JoinQueue:output_type -> matching_service.JoinQueueResponse
	7,  // 9: matching_service.QueueService.CheckQueueStatus:output_type -> matching_service.CheckQueueStatusResponse
	9,  // 10: matching_service.QueueService.LeaveQueue:output_type -> matching_service.LeaveQueueResponse
...
func file_matching_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_matching_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LeaveQueueRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_matching_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LeaveQueueResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
