...
// tslint:disable
import { SetHistoryCompletionResponse } from "./history-service";
import { SetHistoryCompletionRequest } from "./history-service";
...
export interface IHistoryService extends grpc.UntypedServiceImplementation {
    ...
    /**
     * @generated from protobuf rpc: SetHistoryCompletion(history_service.SetHistoryCompletionRequest) returns (history_service.SetHistoryCompletionResponse);
     */
    setHistoryCompletion: grpc.handleUnaryCall<SetHistoryCompletionRequest, SetHistoryCompletionResponse>;
}
/**
...
export const historyServiceDefinition: grpc.ServiceDefinition<IHistoryService> = {
    ...
    setHistoryCompletion: {
        path: "/history_service.HistoryService/SetHistoryCompletion",
        originalName: "SetHistoryCompletion",
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => SetHistoryCompletionResponse.fromBinary(bytes),
        requestDeserialize: bytes => SetHistoryCompletionRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(SetHistoryCompletionResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(SetHistoryCompletionRequest.toBinary(value))
    }
};
