...
// tslint:disable
import { ChangePasswordResponse } from "./user-service";
import { ChangePasswordRequest } from "./user-service";
import { ChangeNicknameResponse } from "./user-service";
import { ChangeNicknameRequest } from "./user-service";
...
export interface IUserService extends grpc.UntypedServiceImplementation {
    ...
    /**
     * @generated from protobuf rpc: ChangeNickname(user_service.ChangeNicknameRequest) returns (user_service.ChangeNicknameResponse);
     */
    changeNickname: grpc.handleUnaryCall<ChangeNicknameRequest, ChangeNicknameResponse>;
    /**
     * @generated from protobuf rpc: ChangePassword(user_service.ChangePasswordRequest) returns (user_service.ChangePasswordResponse);
     */
...
export const userServiceDefinition: grpc.ServiceDefinition<IUserService> = {
    ...
    changeNickname: {
        path: "/user_service.UserService/ChangeNickname",
        originalName: "ChangeNickname",
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => ChangeNicknameResponse.fromBinary(bytes),
        requestDeserialize: bytes => ChangeNicknameRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(ChangeNicknameResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(ChangeNicknameRequest.toBinary(value))
    },
    changePassword: {
        ...
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => ChangePasswordResponse.fromBinary(bytes),
        requestDeserialize: bytes => ChangePasswordRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(ChangePasswordResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(ChangePasswordRequest.toBinary(value))
    }
};
