...
// tslint:disable
import { ConsumePasswordResetTokenResponse } from "./user-service";
import { ConsumePasswordResetTokenRequest } from "./user-service";
...
export interface IUserService extends grpc.UntypedServiceImplementation {
    ...
    /**
     * @generated from protobuf rpc: ConsumePasswordResetToken(user_service.ConsumePasswordResetTokenRequest) returns (user_service.ConsumePasswordResetTokenResponse);
     */
    consumePasswordResetToken: grpc.handleUnaryCall<ConsumePasswordResetTokenRequest, ConsumePasswordResetTokenResponse>;
}
/**
...
export const userServiceDefinition: grpc.ServiceDefinition<IUserService> = {
    ...
    consumePasswordResetToken: {
        path: "/user_service.UserService/ConsumePasswordResetToken",
        originalName: "ConsumePasswordResetToken",
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => ConsumePasswordResetTokenResponse.fromBinary(bytes),
        requestDeserialize: bytes => ConsumePasswordResetTokenRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(ConsumePasswordResetTokenResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(ConsumePasswordResetTokenRequest.toBinary(value))
    }
};
